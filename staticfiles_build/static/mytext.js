...
class passwordBox {
    constructor(data) {
        if (alertboxbool == false) {
            ...
            this.box = "<div id=\"alert1\" ><div class=\"alert-box\"><div class=\"alert-message\" id =\"alert-message\">" + data + "</div><div class=\"inputPass\"><input id =\"inputPass\" type=\"password\"><div><div class=\"alert-buttons\"><a id=\"alert-ok\" type=\"button\">Ok</</div><!-- .alert-buttons --></div></div>";
